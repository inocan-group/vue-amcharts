...
import { PyramidSeries, SlicedChart } from '@amcharts/amcharts4/charts'
...
export default defineComponent({
  ...
  setup(props: IDictionary, context: SetupContext) {
    const series: Ref<PyramidSeries> = ref(new PyramidSeries())
    ...
    register(ChartType.series, props.id, PyramidSeries, series)
